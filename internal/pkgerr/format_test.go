...
func TestFormatErrorf(t *testing.T) {
	tests := []struct {
		...
		"error\n" +
			...
			"\t.+/nextf/errors/internal/pkgerr/format_test.go:56",
	}}
...
func TestFormatWrapf(t *testing.T) {
	tests := []struct {
		...
		"error\n" +
			"github.com/nextf/errors/internal/pkgerr.TestFormatWrapf\n" +
			"\t.+/nextf/errors/internal/pkgerr/format_test.go:149",
	}}
...
func TestFormatWithStack(t *testing.T) {
	tests := []struct {
		...
		[]string{"error1",
			"github.com/nextf/errors/internal/pkgerr.TestFormatWithStack\n" +
				"\t.+/nextf/errors/internal/pkgerr/format_test.go:216",
			"github.com/nextf/errors/internal/pkgerr.TestFormatWithStack\n" +
				"\t.+/nextf/errors/internal/pkgerr/format_test.go:216"},
	}}
	...
	tests := []struct {
		...
		[]string{
			...
			"github.com/nextf/errors/internal/pkgerr.TestFormatWithMessage\n" +
				"\t.+/nextf/errors/internal/pkgerr/format_test.go:244",
			"error2"},
	}, {
		...
		[]string{
			"EOF",
			"github.com/nextf/errors/internal/pkgerr.TestFormatWithMessage\n" +
				"\t.+/nextf/errors/internal/pkgerr/format_test.go:293",
			"inside-error",
			"github.com/nextf/errors/internal/pkgerr.TestFormatWithMessage\n" +
				"\t.+/nextf/errors/internal/pkgerr/format_test.go:293",
			"outside-error"},
	...
	wrappers := []wrapper{
		{
			...
			[]string{
				...
				"github.com/nextf/errors/internal/pkgerr.(func·004|TestFormatGeneric.func4)\n\t" +
					".+/nextf/errors/internal/pkgerr/format_test.go:346",
			},
		},
	}
...
func TestFormatWrappedNew(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"error\n" +
			"github.com/nextf/errors/internal/pkgerr.wrappedNew\n" +
			"\t.+/nextf/errors/internal/pkgerr/format_test.go:364\n" +
			"github.com/nextf/errors/internal/pkgerr.TestFormatWrappedNew\n" +
			"\t.+/nextf/errors/internal/pkgerr/format_test.go:373",
	}}
